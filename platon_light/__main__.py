...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description="Platon Light - Advanced Binance Scalping Trading Bot")
    parser.add_argument("--config", type=str, default="config.yaml", help="Path to configuration file")
    parser.add_argument("--dry-run", action="store_true", help="Run in simulation mode without real trading")
