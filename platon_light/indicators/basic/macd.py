...
class MACD(BaseIndicator):
    ...
    def __init__(self, fast_period=12, slow_period=26, signal_period=9, 
                 input_column='close', output_column=None):
        """
    ...
    def calculate(self, data):
        ...
        fast_ema_indicator = EMA(period=self.fast_period, input_column=self.input_column)
        slow_ema_indicator = EMA(period=self.slow_period, input_column=self.input_column)
        ...
        signal_indicator = EMA(period=self.signal_period, input_column=self.input_column)
